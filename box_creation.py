...
def create_tribal_folders(client, parent_id):
    ...
    tribal_folder = create_folder(client, parent_id, f"Week {WEEK_NUMBER} Tribal ({TRIBAL_DATE})")
    create_folder(client, tribal_folder, f"Week {WEEK_NUMBER} Tribal Videos")
    tribal_confessionals = create_folder(client, tribal_folder, f" Week {WEEK_NUMBER} Confessionals")
...
def main():
    ...
    player_self_uploads = create_folder(client, root_folder, f"Week {WEEK_NUMBER} Player Self-Uploads")
    ...
    create_folder(client, root_folder, f"Week {WEEK_NUMBER} Dream Team")
    create_folder(client, root_folder, f"Week {WEEK_NUMBER} Miscellaneous")
